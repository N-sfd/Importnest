...
export const CATEGORY_DEMO_PRODUCTS: Record<string, CategoryDemoProduct[]> = {
  electronics: withBadges("electronics", [
    ...
    { title: "Vantage 13\" Ultrabook", brand: "Nordstream", subtype: "laptop", subtitle: "Thin-and-light laptop for everyday work" },
    ...
    { title: "Solace Smart Watch SE", brand: "Everline", subtype: "smartwatch", subtitle: "Fitness and notifications on your wrist" },
    ...
    { title: "ArcadePad Gaming Controller", brand: "Alto", subtype: "gaming", subtitle: "Wireless gamepad for console and PC" },
  ]),
  ...
  kitchen: withBadges("kitchen", [
    ...
    { title: "Riverglen Kitchen Utensil Set", brand: "Bramblewood", subtype: "utensils", subtitle: "Heat-safe utensils with crock" },
    ...
    { title: "Drawerline Kitchen Organizer", brand: "Bramblewood", subtype: "kitchen organizer", subtitle: "Expandable drawer organizer" },
  ]),
  footwear: withBadges("footwear", [
    { title: "Pinnacle Trail Runner", brand: "Cadence", subtype: "running shoe", subtitle: "Lightweight shoe for trail and road" },
    ...
    { title: "Easystep Slip-On Shoe", brand: "Cadence", subtype: "slip-on", subtitle: "No-tie slip-on for travel days" },
  ]),
  beauty: withBadges("beauty", [
    ...
    { title: "Lumenne Facial Cleansing Brush", brand: "Sable & Co.", subtype: "facial brush", subtitle: "Gentle daily cleansing device" },
  ...
  accessories: withBadges("accessories", [
    ...
    { title: "Kestrel Laptop Backpack", brand: "Portside", subtype: "backpack", subtitle: "Padded backpack with laptop compartment" },
    ...
    { title: "Millpond Fast-Charge Cable Set", brand: "Portside", subtype: "charging cable", subtitle: "Braided charging cables, 3-pack" },
    ...
    { title: "Orbit Wireless Charging Pad", brand: "Coalridge", subtype: "wireless charging pad", subtitle: "Qi charging pad for phones" },
  ]),
  automotive: withBadges("automotive", [
    ...
    { title: "Trailhead Portable Jump Starter", brand: "Roadcrest", subtype: "jump starter", subtitle: "Compact jump starter and power bank" },
  ...
  outdoors: withBadges("outdoors", [
    ...
    { title: "Fernway Camp Chair", brand: "Greylock", subtype: "outdoor chair", subtitle: "Folding camp chair with cup holder" },
    ...
    { title: "Riverstone Camp Stove", brand: "Greylock", subtype: "portable stove", subtitle: "Portable propane camp stove" },
  ]),
  home: withBadges("home", [
    ...
    { title: "Thistledown Throw Pillow Set", brand: "Linden", subtype: "throw pillows", subtitle: "Decorative pillow covers, set of 2" },
    { title: "Hollowbrook Wall Clock", brand: "Linden", subtype: "wall clock", subtitle: "Minimalist wall clock" },
    { title: "Willowcrest Curtain Panels", brand: "Linden", subtype: "curtains", subtitle: "Blackout curtain panels, pair" },
    { title: "Pemberton Diffuser", brand: "Homestead & Co.", subtype: "diffuser", subtitle: "Essential oil diffuser" },
    { title: "Clearair Home Air Purifier", brand: "Homestead & Co.", subtype: "air purifier", subtitle: "Room air purifier with filter" },
    { title: "Softstep Area Rug", brand: "Linden", subtype: "rug", subtitle: "Low-pile living room rug" },
    { title: "Nestline Home Organizer", brand: "Homestead & Co.", subtype: "home organizer", subtitle: "Desktop and drawer organizer set" },
  ]),
};
